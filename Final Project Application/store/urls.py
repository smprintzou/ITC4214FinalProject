...
urlpatterns = [
    ...
    path('add-booking/', views.add_to_cart, name="add-to-cart"),
    path('remove-booking/<int:cart_id>/', views.remove_cart, name="remove-cart"),
    path('plus-booking/<int:cart_id>/', views.plus_cart, name="plus-cart"),
    path('minus-booking/<int:cart_id>/', views.minus_cart, name="minus-cart"),
    path('bookings/', views.cart, name="cart"),

    #URL for Events
    
    path('event/<slug:slug>/', views.detail, name="product-detail"),
